...
## Coordinate with [dsh-plugin-i18n](../dsh-plugin-i18n/SKILL.md)

This skill owns the browser/client architecture; [dsh-plugin-i18n](../dsh-plugin-i18n/SKILL.md) owns localization details. When the client has product-visible copy, use both skills together:
